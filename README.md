...
Fetch is the base runtime. The package also exposes small adapters for Node, Express, Fastify, Elysia, Hono, Bun, Deno, AWS Lambda HTTP API, Cloudflare Workers, Next.js, Vercel, and Netlify.
