...
Compiled runtime helpers mirror the same request typing with `createCompiledRpcHandlerFor<Request>()`, `createCompiledRouteUnaryRpcHandlerFor<Request>()`, `createCompiledRouteStreamRpcHandlerFor<Request>()`, and `createDenoCompiledTransportRequestHandlerFor<Request>()`.
