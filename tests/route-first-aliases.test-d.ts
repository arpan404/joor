...
export type ConciseRpcRouteAliasSurface = [
  ...
  Root.RpcManifestUnaryId<AliasManifest>,
  Root.RpcManifestStreamId<AliasManifest>,
  Root.RpcManifestUnaryInput<AliasManifest, UnaryId>,
  Root.RpcManifestStreamInput<AliasManifest, StreamId>,
  Root.RpcManifestUnaryOutput<AliasManifest, UnaryId>,
  Root.RpcManifestStreamOutput<AliasManifest, StreamId>,
  Root.RpcManifestUnaryBody<AliasManifest>,
  Root.RpcManifestStreamBody<AliasManifest>,
  Root.RpcManifestUnaryBodyResultFor<AliasManifest, UnaryBody>,
  Root.RpcManifestStreamBodyResultFor<AliasManifest, StreamBody>,
  Root.RpcManifestUnaryRequest<AliasManifest, UnaryId>,
  Root.RpcManifestStreamRequest<AliasManifest, StreamId>,
  Root.RpcManifestUnaryBatchRequest<AliasManifest, UnaryBatchRequest>,
  Root.RpcManifestUnaryProtocolBatchRequest<AliasManifest, UnaryBatchRequest>,
  Root.RpcManifestUnaryClientArgs<AliasManifest, UnaryId>,
  Root.RpcManifestStreamClientArgs<AliasManifest, StreamId>,
  Root.RpcUnaryRequestBuilder<AliasRoutes>,
  Root.RpcStreamRequestBuilder<AliasRoutes>,
  Root.RpcManifestUnaryRequestBuilder<AliasManifest>,
  Root.RpcManifestStreamRequestBuilder<AliasManifest>,
  ...
  RpcSubpath.RpcManifestUnaryId<AliasManifest>,
  RpcSubpath.RpcManifestStreamId<AliasManifest>,
  RpcSubpath.RpcManifestUnaryInput<AliasManifest, UnaryId>,
  RpcSubpath.RpcManifestStreamInput<AliasManifest, StreamId>,
  RpcSubpath.RpcManifestUnaryOutput<AliasManifest, UnaryId>,
  RpcSubpath.RpcManifestStreamOutput<AliasManifest, StreamId>,
  RpcSubpath.RpcManifestUnaryBody<AliasManifest>,
  RpcSubpath.RpcManifestStreamBody<AliasManifest>,
  RpcSubpath.RpcManifestUnaryBodyResultFor<AliasManifest, UnaryBody>,
  RpcSubpath.RpcManifestStreamBodyResultFor<AliasManifest, StreamBody>,
  RpcSubpath.RpcManifestUnaryRequest<AliasManifest, UnaryId>,
  RpcSubpath.RpcManifestStreamRequest<AliasManifest, StreamId>,
  RpcSubpath.RpcManifestUnaryBatchRequest<AliasManifest, UnaryBatchRequest>,
  RpcSubpath.RpcManifestUnaryProtocolBatchRequest<
    AliasManifest,
    UnaryBatchRequest
  >,
  RpcSubpath.RpcManifestUnaryClientArgs<AliasManifest, UnaryId>,
  RpcSubpath.RpcManifestStreamClientArgs<AliasManifest, StreamId>,
  RpcSubpath.RpcUnaryRequestBuilder<AliasRoutes>,
  RpcSubpath.RpcStreamRequestBuilder<AliasRoutes>,
  RpcSubpath.RpcManifestUnaryRequestBuilder<AliasManifest>,
  RpcSubpath.RpcManifestStreamRequestBuilder<AliasManifest>,
];
...
export type ConciseJoorManifestAliasSurface = [
  Root.JoorManifestUnaryId<AliasManifest>,
  Root.JoorManifestStreamId<AliasManifest>,
  Root.JoorManifestUnaryProcedure<AliasManifest, UnaryId>,
  Root.JoorManifestStreamProcedure<AliasManifest, StreamId>,
  Root.JoorManifestUnaryInput<AliasManifest, UnaryId>,
  Root.JoorManifestStreamInput<AliasManifest, StreamId>,
  Root.JoorManifestUnaryOutput<AliasManifest, UnaryId>,
  Root.JoorManifestStreamOutput<AliasManifest, StreamId>,
  Root.JoorManifestUnaryRequiredServices<AliasManifest>,
  Root.JoorManifestStreamRequiredServices<AliasManifest>,
  Root.JoorManifestUnaryRequiredRuntimeRequest<AliasManifest>,
  Root.JoorManifestStreamRequiredRuntimeRequest<AliasManifest>,
  Root.JoorManifestUnaryHeaders<AliasManifest, UnaryId>,
  Root.JoorManifestStreamHeaders<AliasManifest, StreamId>,
  Root.JoorManifestUnaryClientHeaders<AliasManifest, UnaryId>,
  Root.JoorManifestStreamClientHeaders<AliasManifest, StreamId>,
  Root.JoorManifestUnaryHasHeaders<AliasManifest, UnaryId>,
  Root.JoorManifestStreamHasHeaders<AliasManifest, StreamId>,
  Root.JoorManifestUnaryRequiresHeaders<AliasManifest, UnaryId>,
  Root.JoorManifestStreamRequiresHeaders<AliasManifest, StreamId>,
  Root.JoorManifestUnaryResponseHeaders<AliasManifest, UnaryId>,
  Root.JoorManifestStreamResponseHeaders<AliasManifest, StreamId>,
  Root.JoorManifestUnaryHasResponseHeaders<AliasManifest, UnaryId>,
  Root.JoorManifestStreamHasResponseHeaders<AliasManifest, StreamId>,
  Root.JoorManifestUnaryRequiresResponseHeaders<AliasManifest, UnaryId>,
  Root.JoorManifestStreamRequiresResponseHeaders<AliasManifest, StreamId>,
  Root.JoorManifestUnaryError<AliasManifest, UnaryId>,
  Root.JoorManifestStreamError<AliasManifest, StreamId>,
  Root.JoorManifestUnaryErrorCode<AliasManifest, UnaryId>,
  Root.JoorManifestStreamErrorCode<AliasManifest, StreamId>,
  Root.JoorManifestUnaryErrorDetails<AliasManifest, UnaryId>,
  Root.JoorManifestStreamErrorDetails<AliasManifest, StreamId>,
  Root.JoorManifestUnaryEnvelope<AliasManifest, UnaryId>,
  Root.JoorManifestUnaryEnvelopeUnion<AliasManifest>,
  Root.JoorManifestUnaryResult<AliasManifest, UnaryId>,
  Root.JoorManifestUnaryResultUnion<AliasManifest>,
  Root.JoorManifestUnaryRequest<AliasManifest, UnaryId>,
  Root.JoorManifestUnaryRequestUnion<AliasManifest>,
  Root.JoorManifestStreamRequest<AliasManifest, StreamId>,
  Root.JoorManifestStreamRequestUnion<AliasManifest>,
  Root.JoorManifestUnaryBody<AliasManifest>,
  Root.JoorManifestStreamBody<AliasManifest>,
  Root.JoorManifestUnaryBodyResult<AliasManifest>,
  Root.JoorManifestStreamBodyResult<AliasManifest>,
  Root.JoorManifestUnaryBodyResultFor<AliasManifest, UnaryBody>,
  Root.JoorManifestStreamBodyResultFor<AliasManifest, StreamBody>,
  Root.JoorManifestUnaryBodyHandler<AliasManifest>,
  Root.JoorManifestStreamBodyHandler<AliasManifest>,
  Root.JoorManifestUnaryBodyResultHandler<AliasManifest>,
  Root.JoorManifestStreamBodyResultHandler<AliasManifest>,
  Root.JoorManifestUnaryTransportBodyResultHandler<AliasManifest>,
  Root.JoorManifestStreamTransportBodyResultHandler<AliasManifest>,
  Root.JoorManifestUnaryBatchRequestUnion<AliasManifest>,
  Root.JoorManifestUnaryProtocolBatchRequestUnion<AliasManifest>,
  Root.JoorManifestUnaryBatchRequest<AliasManifest, UnaryBatchRequest>,
  Root.JoorManifestUnaryProtocolBatchRequest<AliasManifest, UnaryBatchRequest>,
  Root.JoorManifestUnaryBatchResults<AliasManifest, UnaryBatchRequest>,
  Root.JoorManifestUnaryProtocolBatchResults<AliasManifest, UnaryBatchRequest>,
  Root.JoorManifestUnaryBatchClientHeaders<AliasManifest, UnaryBatchRequest>,
  Root.JoorManifestUnaryProtocolBatchClientHeaders<
    AliasManifest,
    UnaryBatchRequest
  >,
  Root.JoorManifestUnaryBatchOptions<AliasManifest, UnaryBatchRequest>,
  Root.JoorManifestUnaryProtocolBatchOptions<AliasManifest, UnaryBatchRequest>,
  Root.JoorManifestUnaryBatchOptionsTuple<AliasManifest, UnaryBatchRequest>,
  Root.JoorManifestUnaryProtocolBatchOptionsTuple<
    AliasManifest,
    UnaryBatchRequest
  >,
  Root.JoorManifestStreamEvent<AliasManifest, StreamId>,
  Root.JoorManifestStreamRequestBuilder<AliasManifest>,
  Root.JoorManifestUnaryRequestBuilder<AliasManifest>,
  Root.JoorManifestUnaryRequestOptions<AliasManifest, UnaryId>,
  Root.JoorManifestStreamRequestOptions<AliasManifest, StreamId>,
  Root.JoorManifestUnaryClientArgs<AliasManifest, UnaryId>,
  Root.JoorManifestStreamClientArgs<AliasManifest, StreamId>,
  ManifestSubpath.JoorManifestUnaryId<AliasManifest>,
  ManifestSubpath.JoorManifestStreamId<AliasManifest>,
  ManifestSubpath.JoorManifestUnaryBody<AliasManifest>,
  ManifestSubpath.JoorManifestStreamBody<AliasManifest>,
  ManifestSubpath.JoorManifestUnaryBodyHandler<AliasManifest>,
  ManifestSubpath.JoorManifestStreamBodyHandler<AliasManifest>,
  ManifestSubpath.JoorManifestUnaryTransportBodyResultHandler<AliasManifest>,
  ManifestSubpath.JoorManifestStreamTransportBodyResultHandler<AliasManifest>,
  ManifestSubpath.JoorManifestUnaryBatchRequest<AliasManifest, UnaryBatchRequest>,
  ManifestSubpath.JoorManifestUnaryProtocolBatchRequest<
    AliasManifest,
    UnaryBatchRequest
  >,
  ManifestSubpath.JoorManifestStreamRequest<AliasManifest, StreamId>,
  ManifestSubpath.JoorManifestUnaryClientArgs<AliasManifest, UnaryId>,
  ManifestSubpath.JoorManifestStreamClientArgs<AliasManifest, StreamId>,
];
...
export type RootRouteFirstRpcAliasSurface = [
  ...
  Root.RpcManifestUnaryRequiredServices<AliasManifest>,
  Root.RpcManifestStreamRequiredServices<AliasManifest>,
  Root.RpcManifestUnaryRequiredRuntimeRequest<AliasManifest>,
  Root.RpcManifestStreamRequiredRuntimeRequest<AliasManifest>,
  ...
  Root.RpcManifestStreamHandlerOptionsFor<
    ...
    StreamBody
  >,
  Root.RpcManifestUnaryHandlerHookContextFor<
    AliasManifest,
    AliasPlugins,
    UnaryBody
  >,
  Root.RpcManifestStreamHandlerHookContextFor<
    AliasManifest,
    AliasPlugins,
    StreamBody
  >,
  Root.RpcManifestUnaryHandlerHooksFor<
    AliasManifest,
    AliasPlugins,
    UnaryBody
  >,
  Root.RpcManifestStreamHandlerHooksFor<
    AliasManifest,
    AliasPlugins,
    StreamBody
  >,
  Root.RpcManifestUnaryMiddlewareFor<AliasManifest, AliasPlugins, UnaryBody>,
  Root.RpcManifestStreamMiddlewareFor<AliasManifest, AliasPlugins, StreamBody>,
...
export type RpcSubpathRouteFirstAliasSurface = [
  ...
  RpcSubpath.RpcManifestUnaryRequiredServices<AliasManifest>,
  RpcSubpath.RpcManifestStreamRequiredServices<AliasManifest>,
  RpcSubpath.RpcManifestUnaryRequiredRuntimeRequest<AliasManifest>,
  RpcSubpath.RpcManifestStreamRequiredRuntimeRequest<AliasManifest>,
  ...
  RpcSubpath.RpcManifestStreamHandlerOptionsFor<
    ...
    StreamBody
  >,
  RpcSubpath.RpcManifestUnaryHandlerHookContextFor<
    AliasManifest,
    AliasPlugins,
    UnaryBody
  >,
  RpcSubpath.RpcManifestStreamHandlerHookContextFor<
    AliasManifest,
    AliasPlugins,
    StreamBody
  >,
  RpcSubpath.RpcManifestUnaryHandlerHooksFor<
    AliasManifest,
    AliasPlugins,
    UnaryBody
  >,
  RpcSubpath.RpcManifestStreamHandlerHooksFor<
    AliasManifest,
    AliasPlugins,
    StreamBody
  >,
  RpcSubpath.RpcManifestUnaryMiddlewareFor<
    AliasManifest,
    AliasPlugins,
    UnaryBody
  >,
  RpcSubpath.RpcManifestStreamMiddlewareFor<
    AliasManifest,
    AliasPlugins,
    StreamBody
  >,
