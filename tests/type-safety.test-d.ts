...
import {
  ...
  type CompiledRpcRouteStreamBodyResultHandlerForConfig as RootCompiledRpcRouteStreamBodyResultHandlerForConfig,
  type CompiledRpcRouteStreamTransportBodyResultHandlerFor as RootCompiledRpcRouteStreamTransportBodyResultHandlerFor,
  type CompiledRpcRouteStreamTransportBodyResultHandlerForConfig as RootCompiledRpcRouteStreamTransportBodyResultHandlerForConfig,
  type CompiledRpcRouteUnaryBodyResultHandlerFor as RootCompiledRpcRouteUnaryBodyResultHandlerFor,
  type CompiledRpcRouteUnaryBodyResultHandlerForConfig as RootCompiledRpcRouteUnaryBodyResultHandlerForConfig,
  type CompiledRpcRouteUnaryTransportBodyResultHandlerFor as RootCompiledRpcRouteUnaryTransportBodyResultHandlerFor,
  type CompiledRpcRouteUnaryTransportBodyResultHandlerForConfig as RootCompiledRpcRouteUnaryTransportBodyResultHandlerForConfig,
  type CompiledRpcStreamRouteBodyResultHandlerFor as RootCompiledRpcStreamRouteBodyResultHandlerFor,
  type CompiledRpcStreamRouteBodyResultHandlerForConfig as RootCompiledRpcStreamRouteBodyResultHandlerForConfig,
  type CompiledRpcStreamRouteTransportBodyResultHandlerFor as RootCompiledRpcStreamRouteTransportBodyResultHandlerFor,
  type CompiledRpcStreamRouteTransportBodyResultHandlerForConfig as RootCompiledRpcStreamRouteTransportBodyResultHandlerForConfig,
  ...
  type JoorManifestRouteBatchOptionsTuple,
  ...
  type RpcManifestUnaryRouteBatchOptionsTuple,
  ...
  type RpcRouteBatchOptionsTuple,
  type RpcRouteProtocolBatchRequest,
  type RpcRouteProtocolBatchResults,
  ...
  type RpcRouteUnaryProtocolBatchResults,
  ...
  type RpcUnaryRouteBatchOptionsTuple,
  type RpcUnaryRouteProcedure,
  type RpcUnaryRouteProtocolBatchRequest,
  type RpcUnaryRouteProtocolBatchResults,
...
import {
  ...
  type RpcManifestRouteBatchOptionsTuple as RpcSubpathManifestRouteBatchOptionsTuple,
  ...
  type RpcRouteProtocolBatchResults as RpcSubpathRouteProtocolBatchResults,
  type RpcRouteProtocolBatchRequestUnion as RpcSubpathRouteProtocolBatchRequestUnion,
  type RpcRouteBatchOptionsTuple as RpcSubpathRouteBatchOptionsTuple,
...
import {
  ...
  type JoorManifestRouteBatchOptionsTuple as JoorSubpathManifestRouteBatchOptionsTuple,
  ...
  type JoorManifestRouteUnaryBatchOptionsTuple as JoorSubpathManifestRouteUnaryBatchOptionsTuple,
  ...
  type JoorManifestUnaryRouteBatchOptionsTuple as JoorSubpathManifestUnaryRouteBatchOptionsTuple,
...
import {
  ...
  createRouteStreamBunFetchFor as createRuntimeSubpathRouteStreamBunFetchFor,
  createRouteStreamBunRpcRequestHandler as createRuntimeSubpathRouteStreamBunRpcRequestHandler,
  createRouteStreamBunRpcRequestHandlerFor as createRuntimeSubpathRouteStreamBunRpcRequestHandlerFor,
  createRouteUnaryBunFetch as createRuntimeSubpathRouteUnaryBunFetch,
  createRouteUnaryBunFetchFor as createRuntimeSubpathRouteUnaryBunFetchFor,
  createRouteUnaryBunRpcRequestHandler as createRuntimeSubpathRouteUnaryBunRpcRequestHandler,
  createRouteUnaryBunRpcRequestHandlerFor as createRuntimeSubpathRouteUnaryBunRpcRequestHandlerFor,
  createStreamRouteBunFetch as createRuntimeSubpathStreamRouteBunFetch,
  createStreamRouteBunFetchFor as createRuntimeSubpathStreamRouteBunFetchFor,
  createStreamRouteBunRpcRequestHandler as createRuntimeSubpathStreamRouteBunRpcRequestHandler,
  createStreamRouteBunRpcRequestHandlerFor as createRuntimeSubpathStreamRouteBunRpcRequestHandlerFor,
  createUnaryRouteBunFetch as createRuntimeSubpathUnaryRouteBunFetch,
...
const manifestRouteProtocolBatchResults: JoorManifestRouteProtocolBatchResults<
  typeof manifest,
  [typeof manifestUnaryProtocolRequest]
> = [manifestRouteEnvelope];
const manifestRouteUnaryProtocolBatchResults: JoorManifestRouteUnaryProtocolBatchResults<
  typeof manifest,
  [typeof manifestUnaryRouteProtocolRequest]
> = manifestRouteProtocolBatchResults;
const manifestUnaryRouteProtocolBatchResults: JoorManifestUnaryRouteProtocolBatchResults<
  typeof manifest,
  [typeof manifestUnaryRouteProtocolRequest]
> = manifestRouteUnaryProtocolBatchResults;
const manifestProtocolBatchResults: JoorManifestProtocolBatchResults<
  typeof manifest,
  [typeof manifestUnaryProtocolRequest]
> = manifestRouteProtocolBatchResults;
const manifestSubpathRouteProtocolBatchResults: JoorSubpathManifestRouteProtocolBatchResults<
  typeof manifest,
  [typeof manifestUnaryProtocolRequest]
> = manifestProtocolBatchResults;
manifestRouteBatchResults[0].id.toUpperCase();
manifestUnaryRouteBatchResults[0].id.toUpperCase();
manifestRouteProtocolBatchResults[0].id.toUpperCase();
manifestRouteUnaryProtocolBatchResults[0].id.toUpperCase();
manifestUnaryRouteProtocolBatchResults[0].id.toUpperCase();
manifestProtocolBatchResults[0].id.toUpperCase();
manifestSubpathRouteProtocolBatchResults[0].id.toUpperCase();
...
const manifestRouteBatchOptionsTuple: JoorManifestRouteBatchOptionsTuple<
  typeof manifest,
  readonly [typeof manifestRouteRequest]
> = [manifestRouteBatchOptions];
const manifestRouteUnaryBatchOptionsTuple: JoorManifestRouteUnaryBatchOptionsTuple<
  typeof manifest,
  readonly [typeof manifestUnaryRouteRequest]
> = manifestRouteBatchOptionsTuple;
const manifestUnaryRouteBatchOptionsTuple: JoorManifestUnaryRouteBatchOptionsTuple<
  typeof manifest,
  readonly [typeof manifestUnaryRouteRequest]
> = manifestRouteUnaryBatchOptionsTuple;
manifestRouteBatchOptionsTuple[0]?.headers?.['x-tenant-id'].toUpperCase();
manifestUnaryRouteBatchOptionsTuple[0]?.headers?.['x-tenant-id'].toUpperCase();
...
const manifestSubpathRouteBatchOptionsTuple: JoorSubpathManifestRouteBatchOptionsTuple<
  typeof manifestFromSubpath,
  readonly [typeof manifestRouteRequest]
> = manifestRouteBatchOptionsTuple;
const manifestSubpathRouteUnaryBatchOptionsTuple: JoorSubpathManifestRouteUnaryBatchOptionsTuple<
  typeof manifestFromSubpath,
  readonly [typeof manifestUnaryRouteRequest]
> = manifestRouteUnaryBatchOptionsTuple;
const manifestSubpathUnaryRouteBatchOptionsTuple: JoorSubpathManifestUnaryRouteBatchOptionsTuple<
  typeof manifestFromSubpath,
  readonly [typeof manifestUnaryRouteRequest]
> = manifestUnaryRouteBatchOptionsTuple;
manifestSubpathRouteBatchOptionsTuple[0]?.headers?.[
  'x-tenant-id'
]?.toUpperCase();
manifestSubpathRouteUnaryBatchOptionsTuple[0]?.headers?.[
  'x-tenant-id'
]?.toUpperCase();
manifestSubpathUnaryRouteBatchOptionsTuple[0]?.headers?.[
  'x-tenant-id'
]?.toUpperCase();
...
const publicManifestRouteProtocolBatchResults: RpcManifestRouteProtocolBatchResults<
  typeof manifest,
  [typeof publicManifestUnaryProtocolRequest]
> = [manifestRouteEnvelope];
const publicManifestRouteUnaryProtocolBatchResults: RpcManifestRouteUnaryProtocolBatchResults<
  typeof manifest,
  [typeof publicManifestUnaryRouteProtocolRequest]
> = publicManifestRouteProtocolBatchResults;
const publicManifestUnaryRouteProtocolBatchResults: RpcManifestUnaryRouteProtocolBatchResults<
  typeof manifest,
  [typeof publicManifestUnaryRouteProtocolRequest]
> = publicManifestRouteUnaryProtocolBatchResults;
const publicManifestProtocolBatchResults: RpcManifestProtocolBatchResults<
  typeof manifest,
  [typeof publicManifestUnaryProtocolRequest]
> = publicManifestRouteProtocolBatchResults;
const rpcSubpathManifestRouteProtocolBatchResults: RpcSubpathManifestRouteProtocolBatchResults<
  typeof manifest,
  [typeof publicManifestUnaryProtocolRequest]
> = publicManifestProtocolBatchResults;
publicManifestUnaryRouteBatchResults[0].id.toUpperCase();
publicManifestRouteProtocolBatchResults[0].id.toUpperCase();
publicManifestRouteUnaryProtocolBatchResults[0].id.toUpperCase();
publicManifestUnaryRouteProtocolBatchResults[0].id.toUpperCase();
publicManifestProtocolBatchResults[0].id.toUpperCase();
rpcSubpathManifestRouteProtocolBatchResults[0].id.toUpperCase();
...
const publicManifestRouteBatchOptionsTuple: RpcManifestRouteBatchOptionsTuple<
  typeof manifest,
  readonly [typeof publicManifestRouteRequest]
> = [publicManifestRouteBatchOptions];
const publicManifestRouteUnaryBatchOptionsTuple: RpcManifestRouteUnaryBatchOptionsTuple<
  typeof manifest,
  readonly [typeof publicManifestUnaryRouteRequest]
> = publicManifestRouteBatchOptionsTuple;
const publicManifestUnaryRouteBatchOptionsTuple: RpcManifestUnaryRouteBatchOptionsTuple<
  typeof manifest,
  readonly [typeof publicManifestUnaryRouteRequest]
> = publicManifestRouteUnaryBatchOptionsTuple;
publicManifestRouteBatchOptionsTuple[0]?.headers?.[
  'x-tenant-id'
]?.toUpperCase();
publicManifestUnaryRouteBatchOptionsTuple[0]?.headers?.[
  'x-tenant-id'
]?.toUpperCase();
...
const rpcSubpathManifestRouteBatchOptionsTuple: RpcSubpathManifestRouteBatchOptionsTuple<
  typeof manifest,
  readonly [typeof publicManifestRouteRequest]
> = publicManifestRouteBatchOptionsTuple;
const rpcSubpathManifestRouteUnaryBatchOptionsTuple: RpcSubpathManifestRouteUnaryBatchOptionsTuple<
  typeof manifest,
  readonly [typeof publicManifestUnaryRouteRequest]
> = publicManifestRouteUnaryBatchOptionsTuple;
const rpcSubpathManifestUnaryRouteBatchOptionsTuple: RpcSubpathManifestUnaryRouteBatchOptionsTuple<
  typeof manifest,
  readonly [typeof publicManifestUnaryRouteRequest]
> = publicManifestUnaryRouteBatchOptionsTuple;
rpcSubpathManifestRouteBatchOptionsTuple[0]?.headers?.[
  'x-tenant-id'
]?.toUpperCase();
rpcSubpathManifestRouteUnaryBatchOptionsTuple[0]?.headers?.[
  'x-tenant-id'
]?.toUpperCase();
rpcSubpathManifestUnaryRouteBatchOptionsTuple[0]?.headers?.[
  'x-tenant-id'
]?.toUpperCase();
...
const exactUnaryRouteHandlerOptionsWithTrailingArgs: RpcManifestUnaryRouteHandlerOptionsWithTrailingArgs<
  typeof manifest,
  [preflight?: boolean],
  readonly [typeof usersPlugin],
  typeof manifestUnaryRouteBody
> = [manifestUnaryRouteHandlerOptions, true];
const exactStreamRouteHandlerOptionsWithTrailingArgs: RpcManifestStreamRouteHandlerOptionsWithTrailingArgs<
  typeof manifest,
  [preflight?: boolean],
  readonly [typeof usersPlugin],
  typeof manifestStreamRouteBody
> = [manifestStreamRouteHandlerOptions, true];
const rpcSubpathExactUnaryRouteHandlerOptionsWithTrailingArgs: RpcSubpathManifestUnaryRouteHandlerOptionsWithTrailingArgs<
  typeof manifest,
  [preflight?: boolean],
  readonly [typeof usersPlugin],
  typeof manifestUnaryRouteBody
> = exactUnaryRouteHandlerOptionsWithTrailingArgs;
const rpcSubpathExactStreamRouteHandlerOptionsWithTrailingArgs: RpcSubpathManifestStreamRouteHandlerOptionsWithTrailingArgs<
  typeof manifest,
  [preflight?: boolean],
  readonly [typeof usersPlugin],
  typeof manifestStreamRouteBody
> = exactStreamRouteHandlerOptionsWithTrailingArgs;
const exactUnaryRouteHandlerOptionsWithPreflightArgs: RpcManifestUnaryRouteHandlerOptionsWithPreflightArgs<
  typeof manifest,
  readonly [typeof usersPlugin],
  typeof manifestUnaryRouteBody
> = rpcSubpathExactUnaryRouteHandlerOptionsWithTrailingArgs;
const exactStreamRouteHandlerOptionsWithPreflightArgs: RpcManifestStreamRouteHandlerOptionsWithPreflightArgs<
  typeof manifest,
  readonly [typeof usersPlugin],
  typeof manifestStreamRouteBody
> = rpcSubpathExactStreamRouteHandlerOptionsWithTrailingArgs;
const rpcSubpathExactUnaryRouteHandlerOptionsWithPreflightArgs: RpcSubpathManifestUnaryRouteHandlerOptionsWithPreflightArgs<
  typeof manifest,
  readonly [typeof usersPlugin],
  typeof manifestUnaryRouteBody
> = exactUnaryRouteHandlerOptionsWithPreflightArgs;
const rpcSubpathExactStreamRouteHandlerOptionsWithPreflightArgs: RpcSubpathManifestStreamRouteHandlerOptionsWithPreflightArgs<
  typeof manifest,
  readonly [typeof usersPlugin],
  typeof manifestStreamRouteBody
> = exactStreamRouteHandlerOptionsWithPreflightArgs;
...
rpcSubpathExactUnaryRouteHandlerOptionsWithPreflightArgs[0]?.plugins?.[0]?.name.toUpperCase();
rpcSubpathExactStreamRouteHandlerOptionsWithPreflightArgs[0]?.plugins?.[0]?.name.toUpperCase();
...
const syncRpcSubpathBodyHandler: RpcSubpathBodyHandler<typeof manifest> =
  syncRpcBodyHandler;
const routeUnaryRpcBodyHandler = createRouteUnaryRpcBodyHandler(
  manifest,
  manifestUnaryRouteHandlerOptions
);
const unaryRouteRpcBodyHandler = createUnaryRouteRpcBodyHandler(
  manifest,
  manifestUnaryRouteHandlerOptions
);
const routeStreamRpcBodyHandler = createRouteStreamRpcBodyHandler(
  manifest,
  manifestStreamRouteHandlerOptions
);
const streamRouteRpcBodyHandler = createStreamRouteRpcBodyHandler(
  manifest,
  manifestStreamRouteHandlerOptions
);
const rpcSubpathRouteUnaryRpcBodyHandler =
  createRpcSubpathRouteUnaryBodyHandler(
    manifest,
    rpcSubpathManifestUnaryRouteHandlerOptions
  );
const rpcSubpathRouteStreamRpcBodyHandler =
  createRpcSubpathRouteStreamBodyHandler(
    manifest,
    rpcSubpathManifestStreamRouteHandlerOptions
  );
const rpcSubpathUnaryRouteRpcBodyHandler =
  createRpcSubpathUnaryRouteBodyHandler(
    manifest,
    rpcSubpathManifestUnaryRouteHandlerOptions
  );
const rpcSubpathStreamRouteRpcBodyHandler =
  createRpcSubpathStreamRouteBodyHandler(
    manifest,
    rpcSubpathManifestStreamRouteHandlerOptions
  );
...
unaryRouteRpcBodyHandler(
  new Request('https://example.com/rpc'),
  manifestUnaryRouteBody
);
routeStreamRpcBodyHandler(
  new Request('https://example.com/rpc'),
  manifestStreamRouteBody
);
streamRouteRpcBodyHandler(
  new Request('https://example.com/rpc'),
  manifestStreamRouteBody
);
rpcSubpathRouteUnaryRpcBodyHandler(
  new Request('https://example.com/rpc'),
  manifestUnaryRouteBody
);
rpcSubpathRouteStreamRpcBodyHandler(
  new Request('https://example.com/rpc'),
  manifestStreamRouteBody
);
rpcSubpathUnaryRouteRpcBodyHandler(
  new Request('https://example.com/rpc'),
  manifestUnaryRouteBody
);
...
routeUnaryRpcBodyHandler(
  new Request('https://example.com/rpc'),
  // @ts-expect-error route-unary body handlers reject stream bodies.
  manifestStreamRouteBody
);
routeStreamRpcBodyHandler(
  new Request('https://example.com/rpc'),
  // @ts-expect-error route-stream body handlers reject unary bodies.
  manifestUnaryRouteBody
);
...
const routeUnaryRpcBodyResultHandler = createRouteUnaryRpcBodyResultHandler(
  manifest,
  manifestUnaryRouteHandlerOptions
);
const unaryRouteRpcBodyResultHandler = createUnaryRouteRpcBodyResultHandler(
  manifest,
  manifestUnaryRouteHandlerOptions
);
const routeStreamRpcBodyResultHandler = createRouteStreamRpcBodyResultHandler(
  manifest,
  manifestStreamRouteHandlerOptions
);
const streamRouteRpcBodyResultHandler = createStreamRouteRpcBodyResultHandler(
  manifest,
  manifestStreamRouteHandlerOptions
);
const rpcSubpathRouteUnaryRpcBodyResultHandler =
  createRpcSubpathRouteUnaryBodyResultHandler(
    manifest,
    rpcSubpathManifestUnaryRouteHandlerOptions
  );
const rpcSubpathRouteStreamRpcBodyResultHandler =
  createRpcSubpathRouteStreamBodyResultHandler(
    manifest,
    rpcSubpathManifestStreamRouteHandlerOptions
  );
const rpcSubpathUnaryRouteRpcBodyResultHandler =
  createRpcSubpathUnaryRouteBodyResultHandler(
    manifest,
    rpcSubpathManifestUnaryRouteHandlerOptions
  );
const rpcSubpathStreamRouteRpcBodyResultHandler =
  createRpcSubpathStreamRouteBodyResultHandler(
    manifest,
    rpcSubpathManifestStreamRouteHandlerOptions
  );
...
Promise.resolve(
  routeUnaryRpcBodyResultHandler(
    new Request('https://example.com/rpc'),
    manifestUnaryRouteBody
  )
);
Promise.resolve(
  unaryRouteRpcBodyResultHandler(
    new Request('https://example.com/rpc'),
    manifestUnaryRouteBody
  )
);
Promise.resolve(
  routeStreamRpcBodyResultHandler(
    new Request('https://example.com/rpc'),
    manifestStreamRouteBody
  )
);
Promise.resolve(
  streamRouteRpcBodyResultHandler(
    new Request('https://example.com/rpc'),
    manifestStreamRouteBody
  )
);
Promise.resolve(
  rpcSubpathRouteUnaryRpcBodyResultHandler(
    new Request('https://example.com/rpc'),
    manifestUnaryRouteBody
  )
);
Promise.resolve(
  rpcSubpathRouteStreamRpcBodyResultHandler(
    new Request('https://example.com/rpc'),
    manifestStreamRouteBody
  )
);
Promise.resolve(
  rpcSubpathUnaryRouteRpcBodyResultHandler(
    new Request('https://example.com/rpc'),
    manifestUnaryRouteBody
  )
);
Promise.resolve(
  rpcSubpathStreamRouteRpcBodyResultHandler(
    new Request('https://example.com/rpc'),
    manifestStreamRouteBody
  )
);
...
const routeUnaryRpcTransportResultHandler =
  createRouteUnaryRpcTransportBodyResultHandler(
    manifest,
    manifestUnaryRouteHandlerOptions
  );
const unaryRouteRpcTransportResultHandler =
  createUnaryRouteRpcTransportBodyResultHandler(
    manifest,
    manifestUnaryRouteHandlerOptions
  );
const routeStreamRpcTransportResultHandler =
  createRouteStreamRpcTransportBodyResultHandler(
    manifest,
    manifestStreamRouteHandlerOptions
  );
const streamRouteRpcTransportResultHandler =
  createStreamRouteRpcTransportBodyResultHandler(
    manifest,
    manifestStreamRouteHandlerOptions
  );
const rpcSubpathRouteUnaryRpcTransportResultHandler =
  createRpcSubpathRouteUnaryTransportBodyResultHandler(
    manifest,
    rpcSubpathManifestUnaryRouteHandlerOptions
  );
const rpcSubpathRouteStreamRpcTransportResultHandler =
  createRpcSubpathRouteStreamTransportBodyResultHandler(
    manifest,
    rpcSubpathManifestStreamRouteHandlerOptions
  );
const rpcSubpathUnaryRouteRpcTransportResultHandler =
  createRpcSubpathUnaryRouteTransportBodyResultHandler(
    manifest,
    rpcSubpathManifestUnaryRouteHandlerOptions
  );
const rpcSubpathStreamRouteRpcTransportResultHandler =
  createRpcSubpathStreamRouteTransportBodyResultHandler(
    manifest,
    rpcSubpathManifestStreamRouteHandlerOptions
  );
...
routeUnaryRpcTransportResultHandler(
  createFetchRequestSourceForTypes(),
  manifestUnaryRouteBody
);
unaryRouteRpcTransportResultHandler(
  createFetchRequestSourceForTypes(),
  manifestUnaryRouteBody
);
routeStreamRpcTransportResultHandler(
  createFetchRequestSourceForTypes(),
  manifestStreamRouteBody
);
streamRouteRpcTransportResultHandler(
  createFetchRequestSourceForTypes(),
  manifestStreamRouteBody
);
rpcSubpathRouteUnaryRpcTransportResultHandler(
  createFetchRequestSourceForTypes(),
  manifestUnaryRouteBody
);
rpcSubpathRouteStreamRpcTransportResultHandler(
  createFetchRequestSourceForTypes(),
  manifestStreamRouteBody
);
rpcSubpathUnaryRouteRpcTransportResultHandler(
  createFetchRequestSourceForTypes(),
  manifestUnaryRouteBody
);
rpcSubpathStreamRouteRpcTransportResultHandler(
  createFetchRequestSourceForTypes(),
  manifestStreamRouteBody
);
...
const requestTypedBunRouteUnaryFetchOptions: BunRouteUnaryFetchOptionsFor<
  typeof manifest,
  readonly [typeof usersPlugin],
  typeof manifestRouteRequest,
  HookAppRequest
...
const unaryRouteBunFetch = createUnaryRouteBunFetch(
  manifest,
  bunUnaryRouteFetchOptions
);
const routeStreamBunFetch = createRouteStreamBunFetch(
  manifest,
  bunRouteStreamFetchOptions
);
...
createRuntimeSubpathRouteUnaryBunFetchFor<HookAppRequest>()(
  manifest,
  requestTypedBunRouteUnaryFetchOptions
);
createRuntimeSubpathUnaryRouteBunFetchFor()(
  manifest,
  runtimeSubpathBunUnaryRouteFetchOptions
);
createRuntimeSubpathRouteStreamBunFetchFor()(
  manifest,
  runtimeSubpathBunRouteStreamFetchOptions
);
...
const routeUnaryBunRpcHandler = createRouteUnaryBunRpcRequestHandler(
  manifest,
  bunRouteUnaryRpcRequestHandlerOptions
);
const unaryRouteBunRpcHandler = createUnaryRouteBunRpcRequestHandler(
  manifest,
  bunUnaryRouteRpcRequestHandlerOptions
);
const routeStreamBunRpcHandler = createRouteStreamBunRpcRequestHandler(
  manifest,
  bunRouteStreamRpcRequestHandlerOptions
);
...
const runtimeSubpathRouteUnaryBunRpcHandler =
  createRuntimeSubpathRouteUnaryBunRpcRequestHandler(
    manifest,
    runtimeSubpathBunRouteUnaryRpcRequestHandlerOptions
  );
const runtimeSubpathUnaryRouteBunRpcHandler =
  createRuntimeSubpathUnaryRouteBunRpcRequestHandler(
    manifest,
    runtimeSubpathBunUnaryRouteRpcRequestHandlerOptions
  );
const runtimeSubpathRouteStreamBunRpcHandler =
...
const typedRouteUnaryBunRpcHandler =
...
createRuntimeSubpathRouteUnaryBunRpcRequestHandlerFor<HookAppRequest>()(
  manifest,
  requestTypedBunRouteUnaryRpcRequestHandlerOptions
);
createRuntimeSubpathUnaryRouteBunRpcRequestHandlerFor()(
  manifest,
  runtimeSubpathBunUnaryRouteRpcRequestHandlerOptions
);
createRuntimeSubpathRouteStreamBunRpcRequestHandlerFor()(
  manifest,
  runtimeSubpathBunRouteStreamRpcRequestHandlerOptions
);
...
typedRouteUnaryBunFetch(
  // @ts-expect-error route-unary Bun fetch factories preserve custom request types.
  new Request('https://example.com/rpc')
);
...
const configTypedCompiledRouteUnaryTransportHandler: CompiledRpcRouteUnaryTransportBodyResultHandlerForConfig<
  typeof manifestAwareConfig
> = createCompiledRouteUnaryRpcTransportBodyResultHandler(
  _serviceTypedCompiledDispatch,
  manifestAwareConfig,
...
const configTypedCompiledUnaryRouteTransportHandler: CompiledRpcUnaryRouteTransportBodyResultHandlerForConfig<
  typeof manifestAwareConfig
> = createCompiledUnaryRouteRpcTransportBodyResultHandler(
  _serviceTypedCompiledDispatch,
  manifestAwareConfig,
...
const configTypedCompiledRouteStreamTransportHandler: CompiledRpcRouteStreamTransportBodyResultHandlerForConfig<
  typeof manifestAwareConfig
> = createCompiledRouteStreamRpcTransportBodyResultHandler(
  _serviceTypedCompiledDispatch,
  manifestAwareConfig,
...
const configTypedCompiledStreamRouteTransportHandler: CompiledRpcStreamRouteTransportBodyResultHandlerForConfig<
  typeof manifestAwareConfig
> = createCompiledStreamRouteRpcTransportBodyResultHandler(
  _serviceTypedCompiledDispatch,
  manifestAwareConfig,
...
const rootConfigTypedCompiledRouteUnaryTransportHandler: RootCompiledRpcRouteUnaryTransportBodyResultHandlerForConfig<
  typeof manifestAwareConfig
...
const rootConfigTypedCompiledUnaryRouteTransportHandler: RootCompiledRpcUnaryRouteTransportBodyResultHandlerForConfig<
  typeof manifestAwareConfig
...
const rootConfigTypedCompiledRouteStreamTransportHandler: RootCompiledRpcRouteStreamTransportBodyResultHandlerForConfig<
  typeof manifestAwareConfig
...
const rootConfigTypedCompiledStreamRouteTransportHandler: RootCompiledRpcStreamRouteTransportBodyResultHandlerForConfig<
  typeof manifestAwareConfig
...
const runtimeSubpathConfigTypedCompiledStreamRouteTransportHandler: RuntimeSubpathCompiledRpcStreamRouteTransportBodyResultHandlerForConfig<
  typeof manifestAwareConfig
> = createRuntimeSubpathCompiledStreamRouteRpcTransportBodyResultHandler(
  _serviceTypedCompiledDispatch,
  manifestAwareConfig,
  _serviceTypedCompiledUnaryDispatch
);
const runtimeSubpathConfigTypedCompiledRouteUnaryTransportHandler: RuntimeSubpathCompiledRpcRouteUnaryTransportBodyResultHandlerForConfig<
  typeof manifestAwareConfig
> = createRuntimeSubpathCompiledRouteUnaryRpcTransportBodyResultHandler(
  _serviceTypedCompiledDispatch,
  manifestAwareConfig,
  _serviceTypedCompiledUnaryDispatch
);
...
configTypedCompiledRouteUnaryTransportHandler(
  createFetchRequestSourceForTypes(),
  manifestRouteUnaryBody
);
configTypedCompiledUnaryRouteTransportHandler(
  createFetchRequestSourceForTypes(),
  manifestUnaryRouteBody
);
configTypedCompiledRouteStreamTransportHandler(
  createFetchRequestSourceForTypes(),
  manifestRouteStreamBody
);
configTypedCompiledStreamRouteTransportHandler(
  createFetchRequestSourceForTypes(),
  manifestStreamRouteBody
);
rootConfigTypedCompiledRouteUnaryTransportHandler(
  createFetchRequestSourceForTypes(),
  manifestRouteUnaryBody
);
rootConfigTypedCompiledUnaryRouteTransportHandler(
  createFetchRequestSourceForTypes(),
  manifestUnaryRouteBody
);
rootConfigTypedCompiledRouteStreamTransportHandler(
  createFetchRequestSourceForTypes(),
  manifestRouteStreamBody
);
rootConfigTypedCompiledStreamRouteTransportHandler(
  createFetchRequestSourceForTypes(),
  manifestStreamRouteBody
);
runtimeSubpathConfigTypedCompiledStreamRouteTransportHandler(
  createFetchRequestSourceForTypes(),
  manifestStreamRouteBody
);
runtimeSubpathConfigTypedCompiledRouteUnaryTransportHandler(
  createFetchRequestSourceForTypes(),
  manifestRouteUnaryBody
);
configTypedCompiledRouteUnaryTransportHandler(
  createFetchRequestSourceForTypes(),
  // @ts-expect-error config-aware route-unary compiled transports reject route-stream bodies.
  manifestRouteStreamBody
);
configTypedCompiledRouteStreamTransportHandler(
  createFetchRequestSourceForTypes(),
  // @ts-expect-error config-aware route-stream compiled transports reject route-unary bodies.
  manifestRouteUnaryBody
);
createCompiledRpcHandler(
  _serviceTypedCompiledDispatch,
...
const configTypedCompiledRouteUnaryBodyHandler: CompiledRpcRouteUnaryBodyResultHandlerForConfig<
  typeof manifestAwareConfig
> = createCompiledRouteUnaryRpcBodyResultHandler(
  _serviceTypedCompiledDispatch,
  manifestAwareConfig,
...
const configTypedCompiledUnaryRouteBodyHandler: CompiledRpcUnaryRouteBodyResultHandlerForConfig<
  typeof manifestAwareConfig
> = createCompiledUnaryRouteRpcBodyResultHandler(
  _serviceTypedCompiledDispatch,
  manifestAwareConfig,
...
const configTypedCompiledRouteStreamBodyHandler: CompiledRpcRouteStreamBodyResultHandlerForConfig<
  typeof manifestAwareConfig
> = createCompiledRouteStreamRpcBodyResultHandler(
  _serviceTypedCompiledDispatch,
  manifestAwareConfig,
...
const configTypedCompiledStreamRouteBodyHandler: CompiledRpcStreamRouteBodyResultHandlerForConfig<
  typeof manifestAwareConfig
> = createCompiledStreamRouteRpcBodyResultHandler(
  _serviceTypedCompiledDispatch,
  manifestAwareConfig,
...
const rootConfigTypedCompiledRouteUnaryBodyHandler: RootCompiledRpcRouteUnaryBodyResultHandlerForConfig<
  typeof manifestAwareConfig
...
const rootConfigTypedCompiledUnaryRouteBodyHandler: RootCompiledRpcUnaryRouteBodyResultHandlerForConfig<
  typeof manifestAwareConfig
...
const rootConfigTypedCompiledRouteStreamBodyHandler: RootCompiledRpcRouteStreamBodyResultHandlerForConfig<
  typeof manifestAwareConfig
...
const rootConfigTypedCompiledStreamRouteBodyHandler: RootCompiledRpcStreamRouteBodyResultHandlerForConfig<
  typeof manifestAwareConfig
...
const runtimeSubpathConfigTypedCompiledRouteUnaryBodyHandler: RuntimeSubpathCompiledRpcRouteUnaryBodyResultHandlerForConfig<
  typeof manifestAwareConfig
> = createRuntimeSubpathCompiledRouteUnaryRpcBodyResultHandler(
  _serviceTypedCompiledDispatch,
  manifestAwareConfig,
  _serviceTypedCompiledUnaryDispatch
);
const runtimeSubpathConfigTypedCompiledStreamRouteBodyHandler: RuntimeSubpathCompiledRpcStreamRouteBodyResultHandlerForConfig<
  typeof manifestAwareConfig
> = createRuntimeSubpathCompiledStreamRouteRpcBodyResultHandler(
  _serviceTypedCompiledDispatch,
  manifestAwareConfig,
  _serviceTypedCompiledUnaryDispatch
);
...
configTypedCompiledRouteUnaryBodyHandler(
  new Request('https://example.com/rpc'),
  manifestRouteUnaryBody
);
configTypedCompiledUnaryRouteBodyHandler(
  new Request('https://example.com/rpc'),
  manifestUnaryRouteBody
);
configTypedCompiledRouteStreamBodyHandler(
  new Request('https://example.com/rpc'),
  manifestRouteStreamBody
);
configTypedCompiledStreamRouteBodyHandler(
  new Request('https://example.com/rpc'),
  manifestStreamRouteBody
);
rootConfigTypedCompiledRouteUnaryBodyHandler(
  new Request('https://example.com/rpc'),
  manifestRouteUnaryBody
);
rootConfigTypedCompiledUnaryRouteBodyHandler(
  new Request('https://example.com/rpc'),
  manifestUnaryRouteBody
);
rootConfigTypedCompiledRouteStreamBodyHandler(
  new Request('https://example.com/rpc'),
  manifestRouteStreamBody
);
rootConfigTypedCompiledStreamRouteBodyHandler(
  new Request('https://example.com/rpc'),
  manifestStreamRouteBody
);
runtimeSubpathConfigTypedCompiledRouteUnaryBodyHandler(
  new Request('https://example.com/rpc'),
  manifestRouteUnaryBody
);
runtimeSubpathConfigTypedCompiledStreamRouteBodyHandler(
  new Request('https://example.com/rpc'),
  manifestStreamRouteBody
);
configTypedCompiledRouteUnaryBodyHandler(
  new Request('https://example.com/rpc'),
  // @ts-expect-error config-aware route-unary compiled body handlers reject route-stream bodies.
  manifestRouteStreamBody
);
configTypedCompiledRouteStreamBodyHandler(
  new Request('https://example.com/rpc'),
  // @ts-expect-error config-aware route-stream compiled body handlers reject route-unary bodies.
  manifestRouteUnaryBody
);
...
const requestTypedConfigCompiledRouteUnaryBodyHandler: CompiledRpcRouteUnaryBodyResultHandlerForConfig<
  typeof exactManifestAwareConfig
> = createCompiledRouteUnaryRpcBodyResultHandler(
  _serviceTypedCompiledDispatch,
  exactManifestAwareConfig,
...
requestTypedConfigCompiledRouteUnaryBodyHandler(
  hookAppRequest,
  manifestRouteUnaryBody
);
requestTypedConfigCompiledRouteUnaryBodyHandler(
...
const routeBatchOptionsTuple: RpcRouteBatchOptionsTuple<
  Routes,
  readonly [typeof routePendingBatchRequest]
> = [routeBatchOptions];
const routeUnaryBatchOptionsTuple: RpcRouteUnaryBatchOptionsTuple<
  Routes,
  readonly [typeof routePendingBatchRequest]
> = routeBatchOptionsTuple;
const unaryRouteBatchOptionsTuple: RpcUnaryRouteBatchOptionsTuple<
  Routes,
  readonly [typeof routePendingBatchRequest]
> = routeUnaryBatchOptionsTuple;
routeBatchOptionsTuple[0]?.headers?.['x-tenant-id'].toUpperCase();
unaryRouteBatchOptionsTuple[0]?.headers?.['x-tenant-id'].toUpperCase();
const rpcSubpathRouteBatchOptions: RpcSubpathRouteBatchOptions<
  Routes,
  readonly [typeof routePendingBatchRequest]
> = routeBatchOptions;
rpcSubpathRouteBatchOptions.headers?.['x-tenant-id'].toUpperCase();
const rpcSubpathRouteBatchOptionsTuple: RpcSubpathRouteBatchOptionsTuple<
  Routes,
  readonly [typeof routePendingBatchRequest]
> = routeBatchOptionsTuple;
rpcSubpathRouteBatchOptionsTuple[0]?.headers?.['x-tenant-id'].toUpperCase();
...
const routeProtocolBatchRequest: RpcRouteProtocolBatchRequest<
  ...
  [typeof routeProtocolRequest]
> = [routeProtocolRequest];
const routeProtocolBatchOptions: RpcRouteBatchOptions<
  Routes,
  readonly [typeof routeProtocolRequest]
> = {
  headers: { authorization: undefined, 'x-tenant-id': 'tenant-1' },
};
const routeProtocolBatchOptionsTuple: RpcRouteBatchOptionsTuple<
  Routes,
  readonly [typeof routeProtocolRequest]
> = [routeProtocolBatchOptions];
routeProtocolBatchOptionsTuple[0].headers['x-tenant-id'].toUpperCase();
// @ts-expect-error protocol batches to header-required routes require batch options.
const _missingRouteProtocolBatchOptionsTuple: RpcRouteBatchOptionsTuple<
  Routes,
  readonly [typeof routeProtocolRequest]
> = [];
_missingRouteProtocolBatchOptionsTuple;
...
// @ts-expect-error protocol route batches require batch headers for header-required routes.
routeClient.batch([standaloneRouteUnaryProtocolRequest] as const);
...
const routeProtocolBatchResults: RpcRouteProtocolBatchResults<
  Routes,
  [typeof routeProtocolRequest]
> = [routeEnvelope];
const routeUnaryProtocolBatchResults: RpcRouteUnaryProtocolBatchResults<
  Routes,
  [typeof unaryRouteProtocolRequestAlias]
> = routeProtocolBatchResults;
const unaryRouteProtocolBatchResults: RpcUnaryRouteProtocolBatchResults<
  Routes,
  [typeof unaryRouteProtocolRequestAlias]
> = routeUnaryProtocolBatchResults;
const protocolBatchResults: RpcProtocolBatchResults<
  Routes,
  [typeof routeProtocolRequest]
> = routeProtocolBatchResults;
const rpcSubpathRouteProtocolBatchResults: RpcSubpathRouteProtocolBatchResults<
  Routes,
  [typeof routeProtocolRequest]
> = protocolBatchResults;
unaryRouteBatchResults[0].id.toUpperCase();
routeProtocolBatchResults[0].id.toUpperCase();
routeUnaryProtocolBatchResults[0].id.toUpperCase();
unaryRouteProtocolBatchResults[0].id.toUpperCase();
protocolBatchResults[0].id.toUpperCase();
rpcSubpathRouteProtocolBatchResults[0].id.toUpperCase();
