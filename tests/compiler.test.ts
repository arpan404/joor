...
import { createFetch as createBunNativeFetch, fetch as bunNativeFetch, serve as serveBunNative, type BunNativeFetchHandler, type BunNativeOptions, type BunNativeServer } from './bun.js';
import { createFetch as createDenoNativeFetch, fetch as denoNativeFetch, serve as serveDenoNative, type DenoNativeFetchHandler, type DenoNativeOptions, type DenoNativeServer } from './deno.js';
import { createHandler as createNodeNativeHandler, handler as nodeNativeHandler, listen as listenNodeNative, type NodeNativeHandler, type NodeNativeOptions, type NodeNativeServer } from './node.js';
...
const bunNativeOptions: BunNativeOptions = { path: '/custom-rpc', maxBodyBytes: 1024 };
...
bunServer.stop?.();
bunServer.ref?.();
const denoNativeOptions: DenoNativeOptions = { path: '/custom-rpc', maxBodyBytes: 1024 };
...
const nodeNativeOptions: NodeNativeOptions = { path: '/custom-rpc', maxBodyBytes: 1024 };
