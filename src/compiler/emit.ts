...
export type RouteStreamOutput<TId extends StreamRouteId> = StreamRouteOutput<TId>;
...
export type RouteStreamResponseHeaders<TId extends StreamRouteId> = StreamRouteResponseHeaders<TId>;
