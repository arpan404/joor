...
${indent}};`
  ...
  await writeFile(
    `${outDir}/client.ts`,
    `import { createManifestClient as createTransportClient, createManifestRouteRequest as createTransportRouteRequest, type ClientBatchOptions } from 'joor/client';
