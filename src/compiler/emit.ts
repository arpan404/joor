...
export type BatchFunction = <const TRequests extends readonly [...RouteBatchRequestUnion[]]>(
  requests: TRequests,
  options?: BatchOptions<NoInfer<TRequests>>
