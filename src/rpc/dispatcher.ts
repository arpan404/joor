...
import type { ClientProcedureHeaders, ClientRequestInit } from './client.js';
...
export type RpcManifestRouteUnaryInput<
  ...
  TId extends RpcManifestRouteUnaryId<TManifest> =
    RpcManifestRouteUnaryId<TManifest>,
> = ProcedureInput<RpcManifestRouteUnaryProcedure<TManifest, TId>>;
...
export type RpcManifestRouteUnaryHasHeaders<
  ...
  TId extends RpcManifestRouteUnaryId<TManifest> =
    RpcManifestRouteUnaryId<TManifest>,
> = ProcedureHasHeaders<RpcManifestRouteUnaryProcedure<TManifest, TId>>;

export type RpcManifestRouteStreamHasHeaders<
  TManifest extends RpcManifest,
  TId extends RpcManifestRouteStreamId<TManifest> =
    RpcManifestRouteStreamId<TManifest>,
> = ProcedureHasHeaders<RpcManifestRouteStreamProcedure<TManifest, TId>>;

export type RpcManifestRouteUnaryRequiresHeaders<
  TManifest extends RpcManifest,
  TId extends RpcManifestRouteUnaryId<TManifest> =
    RpcManifestRouteUnaryId<TManifest>,
> = ProcedureRequiresHeaders<RpcManifestRouteUnaryProcedure<TManifest, TId>>;

export type RpcManifestRouteStreamRequiresHeaders<
  TManifest extends RpcManifest,
  TId extends RpcManifestRouteStreamId<TManifest> =
    RpcManifestRouteStreamId<TManifest>,
> = ProcedureRequiresHeaders<RpcManifestRouteStreamProcedure<TManifest, TId>>;
...
type RpcManifestRouteUnaryServiceContributions<TManifest extends RpcManifest> =
  {
    [TId in RpcManifestRouteUnaryId<TManifest>]: RpcManifestServiceContribution<
      RpcManifestRouteServices<TManifest, TId>
    >;
  }[RpcManifestRouteUnaryId<TManifest>];

export type RpcManifestRouteUnaryRequiredServices<
  TManifest extends RpcManifest,
> = [RpcManifestRouteUnaryServiceContributions<TManifest>] extends [never]
  ? Record<string, never>
...
export type RpcManifestRouteStreamRequiredServices<
  TManifest extends RpcManifest,
...
type RpcManifestRouteUnaryRequestContributions<TManifest extends RpcManifest> =
  {
    [TId in RpcManifestRouteUnaryId<TManifest>]: RpcManifestRequestContribution<
      RpcManifestRouteRuntimeRequest<TManifest, TId>
    >;
  }[RpcManifestRouteUnaryId<TManifest>];

export type RpcManifestRouteUnaryRequiredRuntimeRequest<
  TManifest extends RpcManifest,
> = [RpcManifestRouteUnaryRequestContributions<TManifest>] extends [never]
  ? Request
...
export type RpcManifestRouteStreamRequiredRuntimeRequest<
  TManifest extends RpcManifest,
> = [RpcManifestRouteStreamRequestContributions<TManifest>] extends [never]
  ? Request
...
type RpcManifestRouteEnvelopeFor<
  ...
  TId extends RpcManifestRouteUnaryId<TManifest>,
> = RpcEnvelope<
  RpcManifestRouteUnaryOutput<TManifest, TId> & JsonValue,
  TId,
...
export type RpcManifestRouteClientHeaders<
  TManifest extends RpcManifest,
  TId extends RpcManifestRouteId<TManifest> = RpcManifestRouteId<TManifest>,
> = ClientProcedureHeaders<RpcManifestRouteProcedure<TManifest, TId>>;
...
type RpcHandlerRouteKind = 'unary' | 'stream';
...
type HandlerOptionsForRequirements<
  TManifest extends RpcManifest,
  TPlugins extends readonly JoorPlugin<object>[],
  TBody,
  TRequest extends Request,
...
> = HandlerOptions<TPlugins, TBody, TRequest> & {
  ...
  > extends true
    ...
    : {
        readonly plugins: TPlugins & {
          readonly __joorMissingServices: TRequiredServices;
        };
      }) &
  (HandlerOptionsRequestMatches<TRequiredRequest, TRequest> extends true
    ? unknown
    : {
        readonly __joorRequestTypeMismatch: TRequiredRequest;
      });
...
type HandlerOptionsArgsForRequirements<
  TManifest extends RpcManifest,
  TPlugins extends readonly JoorPlugin<object>[] =
    readonly JoorPlugin<object>[],
  TOptionsOrBody = HandlerOptions<TPlugins, RpcManifestBody<TManifest>>,
  ...
  >,
  TRequest extends Request = RpcManifestRequiredRuntimeRequest<TManifest>,
  TRequiredServices = RpcManifestRequiredServices<TManifest>,
  TRequiredRequest extends Request =
    RpcManifestRequiredRuntimeRequest<TManifest>,
> =
  HandlerOptionsHaveRequiredServices<
...
type HandlerOptionsWithTrailingArgsForRequirements<
  TManifest extends RpcManifest,
  TTrailingArgs extends readonly unknown[],
  TPlugins extends readonly JoorPlugin<object>[] =
    readonly JoorPlugin<object>[],
...
> =
  ...
  > extends true
    ? readonly [
        options?: HandlerOptionsForRequirements<
          TManifest,
          TPlugins,
          TBody,
          TRequest,
...
export function defineRouteStreamHandlerOptions<TManifest extends RpcManifest>(
  ...
  return ((options) =>
    freezeHandlerOptions(
      options
    )) as DefineRouteStreamHandlerOptions<TManifest>;
}
...
const prepareProcedures = (
  ...
  for (const [id, procedure] of Object.entries(manifest.procedures)) {
    if (
      routeKind !== undefined &&
      (routeKind === 'stream') !== (procedure.stream !== undefined)
    ) {
      continue;
    }
    const headerKeys =
...
export function createRpcHandler<TManifest extends RpcManifest>(
  ...
  const handleParsed = (
    createRpcBodyHandler as unknown as (
      manifest: TManifest,
...
export function createRouteUnaryRpcHandler<
  TManifest extends RpcManifest,
  const TPlugins extends readonly JoorPlugin<object>[] = readonly [],
  TRequest extends Request =
    RpcManifestRouteUnaryRequiredRuntimeRequest<TManifest>,
...
export function createRouteUnaryRpcHandler<TManifest extends RpcManifest>(
  manifest: TManifest,
  options: HandlerOptions = {}
): RpcRequestHandler {
  return (
    createRpcHandler as unknown as (
      manifest: TManifest,
      options: HandlerOptions,
      routeKind: RpcHandlerRouteKind
    ) => RpcRequestHandler
  )(manifest, options, 'unary');
}
...
export function createRouteStreamRpcHandler<TManifest extends RpcManifest>(
  manifest: TManifest,
  options: HandlerOptions = {}
): RpcRequestHandler {
  return (
...
>(
  ...
  ...args: RpcManifestRouteUnaryHandlerOptionsArgs<
    ...
    RpcManifestRouteUnaryRequiredRuntimeRequest<TManifest>
  >
) => RpcRequestHandler<RpcManifestRouteUnaryRequiredRuntimeRequest<TManifest>>;
export function createRouteUnaryRpcHandlerFor<TRequest extends Request>(): <
  TManifest extends RpcManifest,
  const TPlugins extends readonly JoorPlugin<object>[] = readonly [],
>(
  manifest: TManifest,
...
>() {
  ...
  >(
    ...
    createRouteUnaryRpcHandler(
      manifest,
      (args[0] ?? {}) as unknown as RpcManifestRouteUnaryHandlerOptionsFor<
        TManifest,
        TPlugins,
        RpcManifestRouteUnaryBody<TManifest>,
        TRequest
...
>(
  ...
  ...args: RpcManifestRouteStreamHandlerOptionsArgs<
    ...
    RpcManifestRouteStreamRequiredRuntimeRequest<TManifest>
  >
) => RpcRequestHandler<RpcManifestRouteStreamRequiredRuntimeRequest<TManifest>>;
export function createRouteStreamRpcHandlerFor<TRequest extends Request>(): <
  TManifest extends RpcManifest,
  const TPlugins extends readonly JoorPlugin<object>[] = readonly [],
>(
  manifest: TManifest,
...
>() {
  ...
  >(
    ...
    createRouteStreamRpcHandler(
      manifest,
      (args[0] ?? {}) as unknown as RpcManifestRouteStreamHandlerOptionsFor<
        TManifest,
        TPlugins,
        RpcManifestRouteStreamBody<TManifest>,
        TRequest
...
export function createRpcBodyHandler<TManifest extends RpcManifest>(
  ...
  const handlerOptions = freezeHandlerOptions(options);
  const handleResult = (
    createRpcBodyResultHandler as unknown as (
      manifest: TManifest,
      options: HandlerOptionsFor<
        TManifest,
        readonly JoorPlugin<object>[],
...
>(
  ...
  RpcManifestRouteUnaryRequiredRuntimeRequest<TManifest>
>;
export function createRouteUnaryRpcBodyHandlerFor<TRequest extends Request>(): <
  TManifest extends RpcManifest,
  const TPlugins extends readonly JoorPlugin<object>[] = readonly [],
>(
  manifest: TManifest,
...
>() {
  ...
  >(
    ...
    createRouteUnaryRpcBodyHandler(
      ...
      >,
      args[1] ?? true
    ) as RpcManifestRouteUnaryBodyHandler<TManifest, TRequest>;
}
...
>() {
  ...
  >(
    ...
    createRouteStreamRpcBodyHandler(
      ...
      >,
      args[1] ?? true
    ) as RpcManifestRouteStreamBodyHandler<TManifest, TRequest>;
}
...
>() {
  ...
  >(
    ...
    createRouteUnaryRpcBodyResultHandler(
      ...
      >,
      args[1] ?? true
    ) as RpcManifestRouteUnaryBodyResultHandler<TManifest, TRequest>;
}
...
>() {
  ...
  >(
    ...
    createRouteStreamRpcBodyResultHandler(
      ...
      >,
      args[1] ?? true
    ) as RpcManifestRouteStreamBodyResultHandler<TManifest, TRequest>;
}
...
>(
  ...
  const handlerOptions = freezeHandlerOptions(options);
  const procedures = prepareProcedures(manifest, routeKind);
...
export function createRpcTransportBodyResultHandlerFor(): <
  TManifest extends RpcManifest,
  const TPlugins extends readonly JoorPlugin<object>[] = readonly [],
>(
  manifest: TManifest,
...
export function createRpcTransportBodyResultHandlerFor() {
  ...
  >(
    ...
    createRpcTransportBodyResultHandler(
      manifest,
      (args[0] ?? {}) as unknown as HandlerOptionsFor<TManifest, TPlugins>,
      args[1] ?? true
    );
}
...
export function createRouteUnaryRpcTransportBodyResultHandlerFor(): <
  TManifest extends RpcManifest,
  const TPlugins extends readonly JoorPlugin<object>[] = readonly [],
>(
  manifest: TManifest,
...
export const createUnaryRouteRpcTransportBodyResultHandlerFor: typeof createRouteUnaryRpcTransportBodyResultHandlerFor =
  createRouteUnaryRpcTransportBodyResultHandlerFor;

export const createUnaryRpcTransportBodyResultHandlerFor: typeof createRouteUnaryRpcTransportBodyResultHandlerFor =
  createRouteUnaryRpcTransportBodyResultHandlerFor;
...
export function createRouteStreamRpcTransportBodyResultHandlerFor(): <
  TManifest extends RpcManifest,
  const TPlugins extends readonly JoorPlugin<object>[] = readonly [],
>(
  manifest: TManifest,
...
export const createStreamRouteRpcTransportBodyResultHandlerFor: typeof createRouteStreamRpcTransportBodyResultHandlerFor =
  createRouteStreamRpcTransportBodyResultHandlerFor;

export const createStreamRpcTransportBodyResultHandlerFor: typeof createRouteStreamRpcTransportBodyResultHandlerFor =
  createRouteStreamRpcTransportBodyResultHandlerFor;
